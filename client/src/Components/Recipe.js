        ...
        <FormGroup className={classes.root}>
          <FormControlLabel
            control={
              <Checkbox
                name='vegetarian'
                checked={checkboxStates.vegetarian}
          ...
          <FormControlLabel
            control={
              <Checkbox
                name='glutenFree'
                checked={checkboxStates.glutenFree}
                onChange={handleChange}
              />
            }
            label='Gluten-Free'
          ...
          />
          <Button onClick={props.onOpenShoppingList}>
            {' '}
            {props.cartOpen ? 'Close cart' : 'Open cart'}{' '}
          </Button>
        </FormGroup>
        <br />
        {isLoading ? (
          ...
          <RecipeList refreshCart={props.refreshCart} recipes={recipes} />
        )}
      </Container>
    </>
  );
